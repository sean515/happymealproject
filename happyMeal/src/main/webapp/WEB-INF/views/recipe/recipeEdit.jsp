...
<div class="container">
	...
	<button class="btn btn-secondary" onclick="location.href='recipe?nowPage=${vo.nowPage }<c:if test="${vo.searchWord!=null}">&searchKey=${vo.searchKey }&searchWord=${vo.searchWord }</c:if>'">리스트</button>
</div>
