...
<div class="container">
	<div style="padding-top: 80px;">
		...
		<div class="row animate-box">
			<h1 class="title" style="display: inline; font-size: 40px">&nbsp사용자
				식단&nbsp&nbsp</h1>
		</div>
	...
	<div class="searchDiv"
		...
		<button type="button" aria-label="Sizing example input"
			...
			<div class="board_header">
				...
				<a style="color: white;" href="/happy/menu?amenu_type_no=1">전문 식단</a>
					</c:if>
					<c:if test="${logDisease=='연식' }">
				<a style="color: white;" href="/happy/menu?amenu_type_no=2">전문 식단</a>
					</c:if>
					<c:if test="${logDisease=='일반식' }">
				<a style="color: white;" href="/happy/menu?amenu_type_no=3">전문 식단</a>
					</c:if>
					<c:if test="${logDisease=='저염식' }">
				<a style="color: white;" href="/happy/menu?amenu_type_no=4">전문 식단</a>
					</c:if>
					<c:if test="${logDisease=='저요오드식' }">
				<a style="color: white;" href="/happy/menu?amenu_type_no=5">전문 식단</a>
					</c:if>
	...
	<div>
		...
		<div class="recipeHeader" style="float: right; margin-top: -50px;">
			...
			<button type="button" class="btn btn-outline-dark"
				onclick="location.href='menuWrite_user'" style="margin-top: 10px">
